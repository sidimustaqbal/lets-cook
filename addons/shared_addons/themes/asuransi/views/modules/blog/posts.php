        ...
        <article class="blog-post">
                ...
                <div class="row-fluid">
                        ...
                        <div class="details">
                            ...
                            <div>
                                <ul class="clearfix">
                                    ...
                                    <li>
                                        <b>Comments:</b><a href="{{url}}#comments"> {{ comments:count_string entry_id=post:id entry_key="blog:post" [module="blog"] }}</a>,
                                    </li>
                                    {{ if keywords }}
                                    <li>
                    ...
                    <div class="blog-intro ">
                        ...
                        <div class=""><a href="{{ url }}" class="btn btn-default">{{ helper:lang line="blog:read_more_label" }}</a></div>
                    </div>
                </div>
