<div class="page-header">
	<h1><?php echo lang('location:kelurahan:'.$mode); ?></h1>
</div>
...
<div class="form-horizontal">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="kode"><?php echo lang('location:nama_kecamatan'); ?> *</label>

		<div class="col-sm-10">
			<?php 
				$value = NULL;
				if($this->input->post('id_kecamatan') != NULL){
					$value = $this->input->post('id_kecamatan');
				}elseif($this->input->get('f-kecamatan') != NULL){
					$value = $this->input->get('f-kecamatan');
				}elseif($mode == 'edit'){
					$value = $fields['id_kecamatan'];
				}
			?>
			<select name="id_kecamatan" class="col-xs-10 col-sm-5" id="kecamatan" >
				<option value="">-- Pilih Kecamatan --</option>
				<?php if (count($kecamatan)>0) { ?>
					<?php foreach ($kecamatan as $kecamatan) { ?>
						<option value="<?php echo $kecamatan['id']; ?>" <?php echo ($value==$kecamatan['id']) ? 'selected' : ''; ?>><?php echo $kecamatan['nama']; ?></option>
					<?php } ?>
				<?php } ?>
			</select>
		</div>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="nama"><?php echo lang('location:nama_kelurahan'); ?> *</label>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="slug"><?php echo lang('location:slug_kelurahan'); ?> *</label>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="kode"><?php echo lang('location:kode_kelurahan'); ?></label>
